...
from mkfst.caching.serializers import StringSerializer

if TYPE_CHECKING:  # pragma: no cover
    from mkfst.caching.plugins import BasePlugin
    from mkfst.caching.serializers import BaseSerializer
